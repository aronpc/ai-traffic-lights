...
const STRINGS = {
  en: {
    ...
    sync_hint: 'See sessions/notifications from other machines on your tailnet. Opt-in — all off by default. The server binds localhost; run `tailscale serve <port>` on each node.',
  ...
  pt: {
    ...
    sync_hint: 'Veja sessões/notificações de outras máquinas da sua tailnet. Opt-in — tudo desligado por padrão. O servidor sobe em localhost; rode `tailscale serve <porta>` em cada nó.',
