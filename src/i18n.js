...
const STRINGS = {
  en: {
    ...
    dev_channel_label: 'Get test builds (dev)',
    dev_channel_hint: 'New versions before they become stable — expect bugs. Turn it off to go back to the latest stable.',
  ...
  pt: {
    ...
    dev_channel_label: 'Receber builds de teste (dev)',
    dev_channel_hint: 'Versões novas antes de virarem estáveis — podem ter bugs. Desligue para voltar à última estável.',
