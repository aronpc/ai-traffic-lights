...
const STRINGS = {
  en: {
    ...
    tips_focus_detached: '• Detached tmux session (no attached client): there is no tab to focus — the click only raises the window. Attach it first: tmux attach -t <session>.',
    ...
    tips_focus_launcher: '• Agents opened by the Quick Launcher get their own tmux session (atl-<agent>), so the click always finds the right pane.',
  ...
  pt: {
    ...
    tips_focus_detached: '• Sessão tmux sem cliente anexado (detached): não existe aba pra focar — o clique só traz a janela. Anexe primeiro: tmux attach -t <sessão>.',
    ...
    tips_focus_launcher: '• Agentes abertos pelo Quick Launcher ganham sessão tmux própria (atl-<agente>), então o clique sempre acha o painel certo.',
